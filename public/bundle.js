...
/***/ function(module, exports, __webpack_require__) {
	...
	var Valid = __webpack_require__(229);
	...
	ReactDOM.render(React.createElement(
	  ...
	  React.createElement(
	    Route,
	    { path: '/', component: Main },
	    React.createElement(Route, { path: 'valid', component: Valid }),
	    React.createElement(Route, { path: 'invalid', component: InValid })
	  )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var extract = __webpack_require__(167);

	module.exports = React.createClass({
		displayName: 'exports',
		handleExtract: function handleExtract() {
			extract();
		},
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function () {
		return fetch('http://localhost:7000/service', {
			...
			} else browserHistory.push('/invalid');
